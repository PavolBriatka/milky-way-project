# milky-way-project
<p>In this project, I decided to try and implement <b><i>MVP pattern</i></b>. I have created specific packages for each of the elements (model, view, presenter). Each package contains files that, in my opinion, belong there and correspond with an element of the <b>MVP pattern</b>.</p>
